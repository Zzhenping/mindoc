...
<div class="manual-reader">
    ...
    <div class="max-w-screen-xl mx-auto my-4">
            ...
            <ol class="ml-3 inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">文章</a>
                    </div>
                </li>
        ...
        <ul class="w-full mb-5">
            ...
            <li class="px-3 py-3 sm:pb-4 border-b rounded-lg border-solid border-gray-300 hover:bg-gray-200 transition-all">
                <a href="">
                    ...
                    <div class="flex items-center relative">
                        <div class="flex items-center px-3 text-gray-500 border-r border-solid border-gray-300">
                                <span class="me-1">
                        ...
                        <div class="flex items-center text-gray-500 px-3">
                                <span class="me-1">
